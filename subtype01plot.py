...
stage0_data = data[data['subtype'] == 0]
stage1_data = data[data['subtype'] == 1]
...
ax.set_title(title_english, fontsize=25, pad=20)
...
ax.tick_params(axis='y', labelsize=16)  # 调整纵坐标刻度的字体大小
...
pdf_file_path = output_folder + 'MDDsubtype_plot.pdf'
png_file_path = output_folder + 'MDDsubtype_plot.png'
